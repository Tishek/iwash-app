...
export function DebugProvider({ children }) {
  ...
  useEffect(() => {
    ...
    console.log = (...args) => { try { orig.log?.(...args); } catch {} addLog('log', ...args); };
    console.info = (...args) => { try { orig.info?.(...args); } catch {} addLog('info', ...args); };
    console.warn = (...args) => { try { orig.warn?.(...args); } catch {} addLog('warn', ...args); };
    console.error = (...args) => { try { orig.error?.(...args); } catch {} addLog('error', ...args); };
