...
exports.returnMarkerStyle = exports.returnMapZoom = exports.markerToGeoJSONFeature = exports.isMarker = exports.generateSpiral = exports.calculateBBox = void 0;
var _react = _interopRequireDefault(require("react"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
const isMarker = child => {
  return /*#__PURE__*/_react.default.isValidElement(child) && child.props !== null && typeof child.props === 'object' && 'coordinate' in child.props;
};
...
exports.markerToGeoJSONFeature = markerToGeoJSONFeature;
const generateSpiral = (center, leaves) => {
...
exports.generateSpiral = generateSpiral;
...
const returnMapZoom = (region, width) => {
  return Math.round(Math.log2(360 / region.longitudeDelta) * (width / 256));
};
exports.returnMapZoom = returnMapZoom;
const returnMarkerStyle = points => {
  if (points >= 50) return {
    width: 84,
    height: 84,
    size: 64,
...
exports.returnMarkerStyle = returnMarkerStyle;
